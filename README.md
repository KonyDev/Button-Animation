# Button-Animation
Application to show the button animation using kony animations.
...
4. Import the project by selecting the Floating button folder.
...
4. Import it into Kony Visualizer Starter Edition 7.0 or above by selecting the Floating button folder.
